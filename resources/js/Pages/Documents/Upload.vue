        ...
        <form v-if="!processing" @submit.prevent="upload" class="max-w-2xl">
            ...
            <div class="mb-6">
                ...
                >
                    ...
                    <p class="text-gray-600 text-xs mt-1">PDF, Images, TXT, MD, CSV, Word, Excel — max 50MB each</p>
                    <input ref="fileInput" type="file" multiple accept=".pdf,.png,.jpg,.jpeg,.gif,.webp,.txt,.md,.csv,.doc,.docx,.xls,.xlsx" class="hidden" @change="handleFileSelect" />
                </div>
